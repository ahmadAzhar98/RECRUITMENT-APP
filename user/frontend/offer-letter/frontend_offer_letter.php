        ...
        <?php if (isset($_SESSION['joinedData']) && !empty($_SESSION['joinedData'])): ?>
           <?php foreach ($_SESSION['joinedData'] as $data): ?>
               <tr>
                 ...
                 <td>
                <a href="../../../hr/offer-letters/<?php echo htmlspecialchars($data['offer_letter']); ?>" target="_blank">View</a>
                </td>
                <td> 
                <a href="../../backend/offer-letter/update.php?status_id=3&app_id=<?php echo htmlspecialchars($data['application_id']); ?>">Accept</a> |  
                <a href="../../backend/offer-letter/update.php?status_id=4&app_id=<?php echo htmlspecialchars($data['application_id']); ?>">Reject</a>
                 </td>
              </tr>
           <?php endforeach; ?>
        <?php else: ?>
